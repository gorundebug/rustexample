...
HOST_LOCAL_MODULE_ARGS += --config 'patch."https://github.com/gorundebug/rustexample.git".order-service-api.path="../order_service_api"'
HOST_LOCAL_MODULE_ARGS += --config 'patch."https://github.com/gorundebug/rustexample.git".inventory-service-api.path="../inventory_service_api"'
...
export RUSTSERVICELIB_SOURCE_CONTEXT := $(DEPENDENCY_PROXY_DOCKER_BASE)/github-raw/gorundebug/rustservicelib/archive/refs/tags/v0.2.29.tar.gz
endif
ifneq ($(strip $(USE_LOCAL_MODULES)),1)
export EXAMPLE_MODEL_SOURCE_CONTEXT := $(DEPENDENCY_GIT_MIRROR_DOCKER_BASE)/github.com/gorundebug/rustexample.git\#v0.2.29
export ORDER_SERVICE_API_SOURCE_CONTEXT := $(DEPENDENCY_GIT_MIRROR_DOCKER_BASE)/github.com/gorundebug/rustexample.git\#v0.2.29
export INVENTORY_SERVICE_API_SOURCE_CONTEXT := $(DEPENDENCY_GIT_MIRROR_DOCKER_BASE)/github.com/gorundebug/rustexample.git\#v0.2.29
endif
endif
