    ...
    > for ProcessOrder
{
    async fn begin_request(
        ...
        data: HandlerData,
    ) -> Result<(MessageContext, ProcessOrderState), HandlerError> {
    ...
    async fn consume_message(
        ...
        state: Arc<Mutex<ProcessOrderState>>,
        _data: HandlerData,
        result_context: Arc<
            ResultContext<
                ProcessOrderState,
    ...
    async fn get_message_id(
        ...
        _stream: &StreamContext<Order, OrderState, String>,
        _state: Arc<Mutex<ProcessOrderState>>,
        value: &OrderState,
    ) -> String {
...
pub fn make_process_order(
    _context: MessageContext,
    _environment: RuntimeEnvironment,
    _config: &HttpEndpointConfig,
) -> RuntimeResult<ProcessOrder> {
    Ok(ProcessOrder {
