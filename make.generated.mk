...
export GOSERVICELIB_SOURCE_CONTEXT ?= $(SERVICEGEN_DEPENDENCY_PROXY_DOCKER_BASE)/github-raw/gorundebug/servicelib/archive/refs/tags/v0.2.13.tar.gz
export RUSTSERVICELIB_SOURCE_CONTEXT ?= $(SERVICEGEN_DEPENDENCY_PROXY_DOCKER_BASE)/github-raw/gorundebug/rustservicelib/archive/refs/tags/v0.2.13.tar.gz
...
git-delete-project: $(GH) ## Delete project repository github.com/gorundebug/rustexample
	@$(GH) repo delete gorundebug/rustexample --yes 2>/dev/null || true
