...
## Stream types
- Input: `InventoryFailure` — `inventoryservice/src/internal/types/inventory_failure.generated.rs`
...
- [ ] Inspect input type `InventoryFailure` in `inventoryservice/src/internal/types/inventory_failure.generated.rs`
