# Task 1/2: `OrderProcessedEndpoint`
...
| Language | `Rust` |
| Kind | `kafka-source` |
| File | `analyticsservice/src/internal/functions/order_processed_endpoint.rs` |
...
- [ ] Open `analyticsservice/src/internal/functions/order_processed_endpoint.rs` and preserve its generated contract
...
- [ ] Append to `spec/progress.md`: `- [x] analyticsservice/task1.md — OrderProcessedEndpoint — Rust — done`