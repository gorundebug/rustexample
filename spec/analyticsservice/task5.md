# Task 5/26: `AnalyticsPaymentsSource`
...
| Language | `Rust` |
| Kind | `custom-source` |
| File | `analyticsservice/src/internal/functions/endpoint/analytics_payments_source.rs` |
...
- [ ] Open `analyticsservice/src/internal/functions/endpoint/analytics_payments_source.rs` and preserve its generated contract
...
- [ ] Append to `spec/progress.md`: `- [x] analyticsservice/task5.md — AnalyticsPaymentsSource — Rust — done`