# Task 24/26: `SubstreamAnalyticsInputSource`
...
| Language | `Rust` |
| Kind | `custom-source` |
| File | `analyticsservice/src/internal/functions/endpoint/substream_analytics_input_source.rs` |
...
- [ ] Open `analyticsservice/src/internal/functions/endpoint/substream_analytics_input_source.rs` and preserve its generated contract
...
- [ ] Append to `spec/progress.md`: `- [x] analyticsservice/task24.md — SubstreamAnalyticsInputSource — Rust — done`