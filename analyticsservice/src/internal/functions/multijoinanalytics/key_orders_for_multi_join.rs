...
#[derive(Clone, Default)] pub struct KeyOrdersForMultiJoin;
#[async_trait]
impl KeyByFunction<AnalyticsEvent, String, AnalyticsEvent> for KeyOrdersForMultiJoin {
...
pub async fn make_key_orders_for_multi_join(_context: MessageContext, _environment: RuntimeEnvironment, _config: &KeyByStreamConfig) -> RuntimeResult<KeyOrdersForMultiJoin> { Ok(KeyOrdersForMultiJoin) }
