...
#[derive(Default)]
pub struct OrderProcessedEndpoint;

#[async_trait]
impl EndpointHandler<(), OrderProcessed, OrderProcessed, String> for OrderProcessedEndpoint {
    fn concurrency(
        &self,
...
pub fn make_order_processed_endpoint(
    _context: MessageContext,
    _environment: RuntimeEnvironment,
    _config: &KafkaEndpointConfig,
) -> RuntimeResult<OrderProcessedEndpoint> {
    Ok(OrderProcessedEndpoint)
}
