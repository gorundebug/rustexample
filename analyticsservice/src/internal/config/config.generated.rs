...
use servicelib::runtime::config::{
    ...
    SplitStreamConfig, StreamConfig, WhenStreamConfig, CaseStreamConfig, SubStreamConfig,
...
impl Default for Streams {
    ...
    966_f64, -1453_f64,
            ...
            analyze_analytics_substream: SubStreamConfig::from(StreamConfig::new(ANALYZE_ANALYTICS_SUBSTREAM_STREAM_ID, "Analyze Analytics Substream").with_graph(
    ANALYTICS_SERVICE_ID, BUILD_SUBSTREAM_ANALYTICS_RESULT_STREAM_ID, [],
    Some("AnalyticsEvent"),
    None::<String>,
    -1740_f64, -2860_f64,
).with_pipeline("substreamAnalytics")),
            build_substream_analytics_result: MapStreamConfig::from(StreamConfig::new(BUILD_SUBSTREAM_ANALYTICS_RESULT_STREAM_ID, "Build Substream Analytics Result").with_graph(
    ANALYTICS_SERVICE_ID, ANALYZE_ANALYTICS_SUBSTREAM_STREAM_ID, [],
    Some("AnalyticsResult"),
    None::<String>,
    -1110_f64, -2860_f64,
).with_pipeline("substreamAnalytics")),
            invoke_analytics_substream: MapStreamConfig::from(StreamConfig::new(INVOKE_ANALYTICS_SUBSTREAM_STREAM_ID, "Invoke Analytics Substream").with_graph(
    ANALYTICS_SERVICE_ID, SUBSTREAM_ANALYTICS_INPUT_STREAM_ID, [],
    Some("AnalyticsResult"),
    None::<String>,
    -1740_f64, -2530_f64,
).with_pipeline("substreamAnalytics")),
            substream_analytics_input: InputStreamConfig { stream: StreamConfig::new(SUBSTREAM_ANALYTICS_INPUT_STREAM_ID, "Substream Analytics Input").with_graph(
    ANALYTICS_SERVICE_ID, 0, [],
    Some("AnalyticsEvent"),
    None::<String>,
    -2362_f64, -2530_f64,
).with_pipeline("substreamAnalytics"), endpoint_id: SUBSTREAM_ANALYTICS_INPUT_ENDPOINT_ID },
            write_substream_analytics: SinkStreamConfig { stream: StreamConfig::new(WRITE_SUBSTREAM_ANALYTICS_STREAM_ID, "Write Substream Analytics").with_graph(
    ANALYTICS_SERVICE_ID, INVOKE_ANALYTICS_SUBSTREAM_STREAM_ID, [],
    Some("AnalyticsResult"),
    None::<String>,
    -1110_f64, -2530_f64,
).with_pipeline("substreamAnalytics"), endpoint_id: SUBSTREAM_ANALYTICS_RESULT_ENDPOINT_ID },
        }
    }
}
    ...
    fn default() -> Self {
        Self {
            ...
            substream_analytics_input: CustomEndpointConfig {
                id: SUBSTREAM_ANALYTICS_INPUT_ENDPOINT_ID, name: "Substream Analytics Input".to_owned(), id_data_connector: ANALYTICS_FUNCTIONS_CONNECTOR_ID,
                tracing_enabled: false,
            },
            substream_analytics_result: CustomEndpointConfig {
                id: SUBSTREAM_ANALYTICS_RESULT_ENDPOINT_ID, name: "Substream Analytics Result".to_owned(), id_data_connector: ANALYTICS_FUNCTIONS_CONNECTOR_ID,
                tracing_enabled: false,
            },
